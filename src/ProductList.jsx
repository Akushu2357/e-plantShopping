        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <span className='cart_quantity_count'>{(addedToCart.reduce((total, item) => total + item.quantity, 0) === 0) ? 0: addedToCart.reduce((total, item) => total + item.quantity, 0)}</span></h1></a></div>
                </div>
            </div>
            {!showCart ? (
                            ...
                            <div className='product-list'>
                                {category.plants.map((plant, plantIndex) => (
                                    <div className='product-card' key={plantIndex}>
                                        ...
                                        {addedToCart.find(item => item.name === plant.name) ?
